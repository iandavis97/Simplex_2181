...
class Application
{
	...
	MyMesh* m_pMesh2 = nullptr;//Mesh for cylinder to generate
	String m_sProgramer = "DEFAULT"; //Name of programmer
	float fTimer;//used to calculate lerping
	float speed = 1.0f;//float value to be changed using key presses
